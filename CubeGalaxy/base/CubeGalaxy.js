...
function main() {
  ...
  viewMatrix.lookAt(0, 30, 30, 0, 0, 0, 0, 1, 0);
...
function initVertexBuffers(gl) {
  ...
  if(!intiArrayBuffer(gl,'a_Position',vertexColorBuffer,gl.FLOAT,))
...
function intiArrayBuffer(gl,attribute,data,type,num){
